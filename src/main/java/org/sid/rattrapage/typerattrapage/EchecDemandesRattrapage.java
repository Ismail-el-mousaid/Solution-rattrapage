...
@Service
@Slf4j
public class EchecDemandesRattrapage  implements IStrategyRattrapage {
    ...
    public File generateFileSQL(String nameTable, MultipartFile inputFileCsv, String outputFileSql) throws IOException {
        HashMap<String, String> mapConcatCorrelationObjetAndDateAbonnement = fileService.readFileEchec(inputFileCsv);
        File outputFile = fileService.writeInFileDemandesKO(outputFileSql, mapConcatCorrelationObjetAndDateAbonnement, nameTable);
